...
const VerificationModal = ({
    ...
    console.log(account_settings.citizen);

    const citizen_data = residence_list.find(residence => residence.value === account_settings.citizen);
    ...
    console.log(is_idv_supported, Number(idv_submissions_left), is_onfido_supported);
